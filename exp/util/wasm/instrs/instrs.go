...
var (
	...
	Clz_I32    = _add(Instr{N: "clz_i32", O: Op_Clz_I32, T: wt.I32{}, A: wt.I32{}})
	Ctz_I32    = _add(Instr{N: "ctz_i32", O: Op_Ctz_I32, T: wt.I32{}, A: wt.I32{}})
	Popcnt_I32 = _add(Instr{N: "popcnt_i32", O: Op_Popcnt_I32, T: wt.I32{}, A: wt.I32{}})
	Add_I32    = _add(Instr{N: "add_i32", O: Op_Add_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	Sub_I32    = _add(Instr{N: "sub_i32", O: Op_Sub_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	Mul_I32    = _add(Instr{N: "mul_i32", O: Op_Mul_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	DivS_I32   = _add(Instr{N: "divs_i32", O: Op_DivS_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	DivU_I32   = _add(Instr{N: "divu_i32", O: Op_DivU_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	RemS_I32   = _add(Instr{N: "rems_i32", O: Op_RemS_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	RemU_I32   = _add(Instr{N: "remu_i32", O: Op_RemU_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	And_I32    = _add(Instr{N: "and_i32", O: Op_And_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	Or_I32     = _add(Instr{N: "or_i32", O: Op_Or_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	Xor_I32    = _add(Instr{N: "xor_i32", O: Op_Xor_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	Shl_I32    = _add(Instr{N: "shl_i32", O: Op_Shl_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	ShrS_I32   = _add(Instr{N: "shrs_i32", O: Op_ShrS_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	ShrU_I32   = _add(Instr{N: "shru_i32", O: Op_ShrU_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	Rotl_I32   = _add(Instr{N: "rotl_i32", O: Op_Rotl_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	Rotr_I32   = _add(Instr{N: "rotr_i32", O: Op_Rotr_I32, T: wt.I32{}, A: wt.I32{}, B: wt.I32{}})
	Clz_I64    = _add(Instr{N: "clz_i64", O: Op_Clz_I64, T: wt.I64{}, A: wt.I64{}})
	Ctz_I64    = _add(Instr{N: "ctz_i64", O: Op_Ctz_I64, T: wt.I64{}, A: wt.I64{}})
	Popcnt_I64 = _add(Instr{N: "popcnt_i64", O: Op_Popcnt_I64, T: wt.I64{}, A: wt.I64{}})
	Add_I64    = _add(Instr{N: "add_i64", O: Op_Add_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	Sub_I64    = _add(Instr{N: "sub_i64", O: Op_Sub_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	Mul_I64    = _add(Instr{N: "mul_i64", O: Op_Mul_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	DivS_I64   = _add(Instr{N: "divs_i64", O: Op_DivS_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	DivU_I64   = _add(Instr{N: "divu_i64", O: Op_DivU_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	RemS_I64   = _add(Instr{N: "rems_i64", O: Op_RemS_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	RemU_I64   = _add(Instr{N: "remu_i64", O: Op_RemU_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	And_I64    = _add(Instr{N: "and_i64", O: Op_And_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	Or_I64     = _add(Instr{N: "or_i64", O: Op_Or_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	Xor_I64    = _add(Instr{N: "xor_i64", O: Op_Xor_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	Shl_I64    = _add(Instr{N: "shl_i64", O: Op_Shl_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	ShrS_I64   = _add(Instr{N: "shrs_i64", O: Op_ShrS_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	ShrU_I64   = _add(Instr{N: "shru_i64", O: Op_ShrU_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	Rotl_I64   = _add(Instr{N: "rotl_i64", O: Op_Rotl_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})
	Rotr_I64   = _add(Instr{N: "rotr_i64", O: Op_Rotr_I64, T: wt.I64{}, A: wt.I64{}, B: wt.I64{}})

	Abs_F32      = _add(Instr{N: "abs_f32", O: Op_Abs_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})
	Neg_F32      = _add(Instr{N: "neg_f32", O: Op_Neg_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})
	Ceil_F32     = _add(Instr{N: "ceil_f32", O: Op_Ceil_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})
	Floor_F32    = _add(Instr{N: "floor_f32", O: Op_Floor_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})
	Trunc_F32    = _add(Instr{N: "trunc_f32", O: Op_Trunc_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})
	Nearest_F32  = _add(Instr{N: "nearest_f32", O: Op_Nearest_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})
	Sqrt_F32     = _add(Instr{N: "sqrt_f32", O: Op_Sqrt_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})
	Add_F32      = _add(Instr{N: "add_f32", O: Op_Add_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})
	Sub_F32      = _add(Instr{N: "sub_f32", O: Op_Sub_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})
	Mul_F32      = _add(Instr{N: "mul_f32", O: Op_Mul_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})
	Div_F32      = _add(Instr{N: "div_f32", O: Op_Div_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})
	Min_F32      = _add(Instr{N: "min_f32", O: Op_Min_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})
	Max_F32      = _add(Instr{N: "max_f32", O: Op_Max_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})
	Copysign_F32 = _add(Instr{N: "copysign_f32", O: Op_Copysign_F32, T: wt.F32{}, A: wt.F32{}, B: wt.F32{}})

	Abs_F64      = _add(Instr{N: "abs_f64", O: Op_Abs_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})
	Neg_F64      = _add(Instr{N: "neg_f64", O: Op_Neg_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})
	Ceil_F64     = _add(Instr{N: "ceil_f64", O: Op_Ceil_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})
	Floor_F64    = _add(Instr{N: "floor_f64", O: Op_Floor_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})
	Trunc_F64    = _add(Instr{N: "trunc_f64", O: Op_Trunc_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})
	Nearest_F64  = _add(Instr{N: "nearest_f64", O: Op_Nearest_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})
	Sqrt_F64     = _add(Instr{N: "sqrt_f64", O: Op_Sqrt_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})
	Add_F64      = _add(Instr{N: "add_f64", O: Op_Add_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})
	Sub_F64      = _add(Instr{N: "sub_f64", O: Op_Sub_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})
	Mul_F64      = _add(Instr{N: "mul_f64", O: Op_Mul_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})
	Div_F64      = _add(Instr{N: "div_f64", O: Op_Div_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})
	Min_F64      = _add(Instr{N: "min_f64", O: Op_Min_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})
	Max_F64      = _add(Instr{N: "max_f64", O: Op_Max_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})
	Copysign_F64 = _add(Instr{N: "copysign_f64", O: Op_Copysign_F64, T: wt.F64{}, A: wt.F64{}, B: wt.F64{}})

	WrapI64_I32        = _add(Instr{N: "wrap_i64_i32", O: Op_WrapI64_I32, T: wt.I32{}, A: wt.I64{}})
	TruncF32S_I32      = _add(Instr{N: "trunc_f32s_i32", O: Op_TruncF32S_I32, T: wt.I32{}, A: wt.F32{}})
	TruncF32U_I32      = _add(Instr{N: "trunc_f32u_i32", O: Op_TruncF32U_I32, T: wt.I32{}, A: wt.F32{}})
	TruncF64S_I32      = _add(Instr{N: "trunc_f64s_i32", O: Op_TruncF64S_I32, T: wt.I32{}, A: wt.F64{}})
	TruncF64U_I32      = _add(Instr{N: "trunc_f64u_i32", O: Op_TruncF64U_I32, T: wt.I32{}, A: wt.F64{}})
	ExtendI32S_I64     = _add(Instr{N: "extend_i32s_i64", O: Op_ExtendI32S_I64, T: wt.I64{}, A: wt.I32{}})
	ExtendI32U_I64     = _add(Instr{N: "extend_i32u_i64", O: Op_ExtendI32U_I64, T: wt.I64{}, A: wt.I32{}})
	TruncF32S_I64      = _add(Instr{N: "trunc_f32s_i64", O: Op_TruncF32S_I64, T: wt.I64{}, A: wt.F32{}})
	TruncF32U_I64      = _add(Instr{N: "trunc_f32u_i64", O: Op_TruncF32U_I64, T: wt.I64{}, A: wt.F32{}})
	TruncF64S_I64      = _add(Instr{N: "trunc_f64s_i64", O: Op_TruncF64S_I64, T: wt.I64{}, A: wt.F64{}})
	TruncF64U_I64      = _add(Instr{N: "trunc_f64u_i64", O: Op_TruncF64U_I64, T: wt.I64{}, A: wt.F64{}})
	ConvertI32S_F32    = _add(Instr{N: "convert_i32s_f32", O: Op_ConvertI32S_F32, T: wt.F32{}, A: wt.I32{}})
	ConvertI32U_F32    = _add(Instr{N: "convert_i32u_f32", O: Op_ConvertI32U_F32, T: wt.F32{}, A: wt.I32{}})
	ConvertI64S_F32    = _add(Instr{N: "convert_i64s_f32", O: Op_ConvertI64S_F32, T: wt.F32{}, A: wt.I64{}})
	ConvertI64U_F32    = _add(Instr{N: "convert_i64u_f32", O: Op_ConvertI64U_F32, T: wt.F32{}, A: wt.I64{}})
	DemoteF64_F32      = _add(Instr{N: "demote_f64_f32", O: Op_DemoteF64_F32, T: wt.F32{}, A: wt.F64{}})
	ConvertI32S_F64    = _add(Instr{N: "convert_i32s_f64", O: Op_ConvertI32S_F64, T: wt.F64{}, A: wt.I32{}})
	ConvertI32U_F64    = _add(Instr{N: "convert_i32u_f64", O: Op_ConvertI32U_F64, T: wt.F64{}, A: wt.I32{}})
	ConvertI64S_F64    = _add(Instr{N: "convert_i64s_f64", O: Op_ConvertI64S_F64, T: wt.F64{}, A: wt.I64{}})
	ConvertI64U_F64    = _add(Instr{N: "convert_i64u_f64", O: Op_ConvertI64U_F64, T: wt.F64{}, A: wt.I64{}})
	PromoteF32_F64     = _add(Instr{N: "promote_f32_f64", O: Op_PromoteF32_F64, T: wt.F64{}, A: wt.F32{}})
	ReinterpretF32_I32 = _add(Instr{N: "reinterpret_f32_i32", O: Op_ReinterpretF32_I32, T: wt.I32{}, A: wt.F32{}})
	ReinterpretF64_I64 = _add(Instr{N: "reinterpret_f64_i64", O: Op_ReinterpretF64_I64, T: wt.I64{}, A: wt.F64{}})
	ReinterpretI32_F32 = _add(Instr{N: "reinterpret_i32_f32", O: Op_ReinterpretI32_F32, T: wt.F32{}, A: wt.I32{}})
	ReinterpretI64_F64 = _add(Instr{N: "reinterpret_i64_f64", O: Op_ReinterpretI64_F64, T: wt.F64{}, A: wt.I64{}})

	Extend8S_I32  = _add(Instr{N: "extend8s_i32", O: Op_Extend8S_I32, T: wt.I32{}, A: wt.I32{}})
	Extend16S_I32 = _add(Instr{N: "extend16s_i32", O: Op_Extend16S_I32, T: wt.I32{}, A: wt.I32{}})
	Extend8S_I64  = _add(Instr{N: "extend8s_i64", O: Op_Extend8S_I64, T: wt.I64{}, A: wt.I64{}})
	Extend16S_I64 = _add(Instr{N: "extend16s_i64", O: Op_Extend16S_I64, T: wt.I64{}, A: wt.I64{}})
	Extend32S_I64 = _add(Instr{N: "extend32s_i64", O: Op_Extend32S_I64, T: wt.I64{}, A: wt.I64{}})

	TruncSatF32S_I32 = _add(Instr{N: "trunc_sat_f32s_i32", O: Op_TruncSatF32S_I32, T: wt.I32{}, A: wt.F32{}})
	TruncSatF32U_I32 = _add(Instr{N: "trunc_sat_f32u_i32", O: Op_TruncSatF32U_I32, T: wt.I32{}, A: wt.F32{}})
	TruncSatF64S_I32 = _add(Instr{N: "trunc_sat_f64s_i32", O: Op_TruncSatF64S_I32, T: wt.I32{}, A: wt.F64{}})
	TruncSatF64U_I32 = _add(Instr{N: "trunc_sat_f64u_i32", O: Op_TruncSatF64U_I32, T: wt.I32{}, A: wt.F64{}})
	TruncSatF32S_I64 = _add(Instr{N: "trunc_sat_f32s_i64", O: Op_TruncSatF32S_I64, T: wt.I64{}, A: wt.F32{}})
	TruncSatF32U_I64 = _add(Instr{N: "trunc_sat_f32u_i64", O: Op_TruncSatF32U_I64, T: wt.I64{}, A: wt.F32{}})
	TruncSatF64S_I64 = _add(Instr{N: "trunc_sat_f64s_i64", O: Op_TruncSatF64S_I64, T: wt.I64{}, A: wt.F64{}})
	TruncSatF64U_I64 = _add(Instr{N: "trunc_sat_f64u_i64", O: Op_TruncSatF64U_I64, T: wt.I64{}, A: wt.F64{}})
