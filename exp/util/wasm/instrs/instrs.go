...
var (
	...
	// Const_I32 = _add(Instr{N: "const_i32", O: Op_Const_I32})
	// Const_I64 = _add(Instr{N: "const_i64", O: Op_Const_I64})
	// Const_F32 = _add(Instr{N: "const_f32", O: Op_Const_F32})
	// Const_F64 = _add(Instr{N: "const_f64", O: Op_Const_F64})

	// Eqz_I32 = _add(Instr{N: "eqz_i32", O: Op_Eqz_I32})
	// Eq_I32 = _add(Instr{N: "eq_i32", O: Op_Eq_I32})
	// Ne_I32 = _add(Instr{N: "ne_i32", O: Op_Ne_I32})
	// LtS_I32 = _add(Instr{N: "lts_i32", O: Op_LtS_I32})
	// LtU_I32 = _add(Instr{N: "ltu_i32", O: Op_LtU_I32})
	// GtS_I32 = _add(Instr{N: "gts_i32", O: Op_GtS_I32})
	// GtU_I32 = _add(Instr{N: "gtu_i32", O: Op_GtU_I32})
	// LeS_I32 = _add(Instr{N: "les_i32", O: Op_LeS_I32})
	// LeU_I32 = _add(Instr{N: "leu_i32", O: Op_LeU_I32})
	// GeS_I32 = _add(Instr{N: "ges_i32", O: Op_GeS_I32})
	// GeU_I32 = _add(Instr{N: "geu_i32", O: Op_GeU_I32})

	// Eqz_I64 = _add(Instr{N: "eqz_i64", O: Op_Eqz_I64})
	// Eq_I64 = _add(Instr{N: "eq_i64", O: Op_Eq_I64})
	// Ne_I64 = _add(Instr{N: "ne_i64", O: Op_Ne_I64})
	// LtS_I64 = _add(Instr{N: "lts_i64", O: Op_LtS_I64})
	// LtU_I64 = _add(Instr{N: "ltu_i64", O: Op_LtU_I64})
	// GtS_I64 = _add(Instr{N: "gts_i64", O: Op_GtS_I64})
	// GtU_I64 = _add(Instr{N: "gtu_i64", O: Op_GtU_I64})
	// LeS_I64 = _add(Instr{N: "les_i64", O: Op_LeS_I64})
	// LeU_I64 = _add(Instr{N: "leu_i64", O: Op_LeU_I64})
	// GeS_I64 = _add(Instr{N: "ges_i64", O: Op_GeS_I64})
	// GeU_I64 = _add(Instr{N: "geu_i64", O: Op_GeU_I64})

	// Eq_F32 = _add(Instr{N: "eq_f32", O: Op_Eq_F32})
	// Ne_F32 = _add(Instr{N: "ne_f32", O: Op_Ne_F32})
	// Lt_F32 = _add(Instr{N: "lt_f32", O: Op_Lt_F32})
	// Gt_F32 = _add(Instr{N: "gt_f32", O: Op_Gt_F32})
	// Le_F32 = _add(Instr{N: "le_f32", O: Op_Le_F32})
	// Ge_F32 = _add(Instr{N: "ge_f32", O: Op_Ge_F32})

	// Eq_F64 = _add(Instr{N: "eq_f64", O: Op_Eq_F64})
	// Ne_F64 = _add(Instr{N: "ne_f64", O: Op_Ne_F64})
	// Lt_F64 = _add(Instr{N: "lt_f64", O: Op_Lt_F64})
	// Gt_F64 = _add(Instr{N: "gt_f64", O: Op_Gt_F64})
	// Le_F64 = _add(Instr{N: "le_f64", O: Op_Le_F64})
	// Ge_F64 = _add(Instr{N: "ge_f64", O: Op_Ge_F64})
