...
//go:noinline
func frob0(u Union1) string {
	return u.Dog().Howl.Howl()
}

//go:noinline
func frob1(u Union1) string {
	return u.Dog_Howl().Howl()
}

//go:noinline
func frob2(u Union1) string {
	return u.View_Dog().Howl().Howl()
}

func main() {
	frob(Union1_Dog(Dog{Woofs: 5, Howl: LoudHowl{}}))
	frob(Union1_Dog(Dog{Woofs: 5, Howl: QuietHowl{}}))
	frob(Union1_Person(Person{Age: 23.4, Money: 420}))

	d := Union1_Dog(Dog{Woofs: 5, Howl: LoudHowl{}})
	frob0(d)
	frob1(d)
	frob2(d)
}
