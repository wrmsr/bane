...
func TestParseGenericName(t *testing.T) {
	...
	tu.AssertEqual(t, pn.String(), "Optional[github.com/wrmsr/bane/pkg/util/container.Map[github.com/wrmsr/bane/pkg/util/optional.Optional[int], github.com/wrmsr/bane/pkg/util/optional.Optional[string]]]")
}
